<?php
/**
 * $Id: PSpell.php,v 1.5 2010/09/22 13:50:26 macleana Exp $
 *
 * @author Moxiecode
...
class PSpell extends SpellChecker {
    ...
    function &getSuggestions($lang, $word) {
        ...
        $limit = $this->_config['general.suggestions.limit'];
        if($limit > 0) {
    ...
    function &_getPLink($lang) {
        ...
        pspell_config_personal($pspell_config, $this->_config['PSpell.personal.dictionary.dir'].$lang);
        pspell_config_mode($pspell_config, $this->_config['PSpell.mode']);
